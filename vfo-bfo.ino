...
#define BUTTON_BAND D6    // Controls the band
#define BUTTON_VFO_BFO D5 // Switch VFO to BFO

// BFO range for this project is 400KHz to 500KHz. The central frequency is 455KHz.
#define MAX_BFO 0LU    // BFO maximum frequency
...
Band band[] = {
    {"160m ", 17000000LLU, 200000000LLU}, // 100KHz to 1700KHz
    {"80m tech ", 352500000LLU, 360000001LLU},   // 80m tech portion
    {"80m  ", 350000000LLU, 400000001LLU},   // 80m ham band
    {"SW1  ", 400000000LLU, 700000000LLU},
    {"40m tech ", 702500000LLU, 712500000LLU},   // 40m tech portion
    ...
    {"SW4  ", 1806800000LLU, 1806800000LLU}, 
    {"17m  ", 1806800000LLU, 1816800000LLU}, // 17m
    {"SW5  ", 1816800000LLU, 2100000000LLU},
    {"15m tech ", 2125000000LLU, 2120000000LLU}, // 15m tech portion
    ...
    {"10m tech", 2800000000LLU, 2850000000LLU}, // 10m tech area
    ...
    {"FM broadcast  ", 8600000000LLU, 10800000000LLU},  // Comercial FM
...
///*
  ...
  display.print("staticFreq:");
  display.println(staticFreq);
  display.print("band:");
  display.println(band[currentBand].name);
  display.print("step:");
